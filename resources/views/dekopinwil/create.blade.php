...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Dekopinwil Create</div>
                <div class="card-body">
                <form method="POST" action="/dekopinda/public/dashboard/dekopinwil/store">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <input type="text" name="nama_dekopinwil" class="form-control" required>
                        </div>
                    </div>
                    <br>
                    <div class="row">
