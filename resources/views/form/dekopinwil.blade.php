                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" value="{{$dekopinwil->no_sk}}" class="form-control" disabled>
                        </div>
                        
                        <div class="col-sm-6">
                        <label class="label">Tanggal SK</label>
                        <input type="text" value="{{$dekopinwil->tgl_sk}}" class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <input type="text" value="{{$dekopinwil->nama_ketua}}" class="form-control" disabled>
                        </div>
                        <div class="col-sm-6">
                        <label class="label">No Kontak/ Phone</label>
                        <input type="text" value="{{$dekopinwil->no_kontak}}" class="form-control" disabled>
                        </div>
                    </div>
                    <br>
                    ...
                    {{csrf_field()}}
                    <input type="hidden" name="id_rel" value="{{$dekopinwil->id}}">
                    <input type="hidden" name="nama" value="{{$dekopinwil->nama_ketua}}">
                    <input type="hidden" name="no_kontak" value="{{$dekopinwil->no_kontak}}">
                    <div class="row">
                        <div class="col-sm-6">
                            <label>Pesawat : </label>
                    ...
                    <input type="hidden" name="slug" value="dekopinwil">
                    <br>
