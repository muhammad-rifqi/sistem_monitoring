                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" value="null" class="form-control" disabled>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <input type="text" value="{{$induk_koperasi->nama}}" class="form-control" disabled>
                        </div>
                        <div class="col-sm-6">
                        <label class="label">No Kontak/ Phone</label>
                        <input type="text" value="{{$induk_koperasi->no_kontak}}" class="form-control" disabled>
                        </div>
                    </div>
                    <br>
                    ...
                    {{csrf_field()}}
                    <input type="hidden" name="id_rel" value="{{$induk_koperasi->id}}">
                    <input type="hidden" name="nama" value="{{$induk_koperasi->nama}}">
                    <input type="hidden" name="no_kontak" value="{{$induk_koperasi->no_kontak}}">
                    <div class="row">
                        <div class="col-sm-6">
                            <label>Pesawat : </label>
                    ...
                    <input type="hidden" name="slug" value="induk_koperasi">
                    <br>
