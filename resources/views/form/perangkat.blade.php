            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <input type="text" value="{{$perangkat->nama}}" class="form-control" disabled>
                        </div>
                        <div class="col-sm-6">
                        <label class="label">No Kontak/ Phone</label>
                        <input type="text" value="{{$perangkat->no_kontak}}" class="form-control" disabled>
                        </div>
                    </div>
                    <br>
                    ...
                    {{csrf_field()}}
                    <input type="hidden" name="id_rel" value="{{$perangkat->id}}">
                    <input type="hidden" name="nama" value="{{$perangkat->nama}}">
                    <input type="hidden" name="no_kontak" value="{{$perangkat->no_kontak}}">
                    <div class="row">
                        <div class="col-sm-6">
                            <label>Pesawat : </label>
                    ...
                    <input type="hidden" name="slug" value="perangkat">
                    <br>
